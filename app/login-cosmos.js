 ...
 * Extracted from app.js in Phase 1 #10. Classic script (matches the rest
 * of the frontend); publishes window.createLoginCosmos so the existing
 * app.js call site is unchanged.
 *
 * Requires THREE.js to be loaded first (CDN, see index.html). When THREE
 * is missing or the #loginWebglContainer DOM node is absent, the function
 * returns null and the caller (app.js openLoginView) silently falls back
...
(function () {
  ...
  window.createLoginCosmos = createLoginCosmos;
})();
