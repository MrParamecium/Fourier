...
const WORKSPACE_MATERIALS_DIR = path.join(PROJECT_ROOT, 'workspace_tutor_related_full', 'tutor-materials');
const ROOT_MATERIALS_DIR = path.join(PROJECT_ROOT, 'tutor-materials');
